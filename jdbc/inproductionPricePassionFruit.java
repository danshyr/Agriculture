...
public class inproductionPricePassionFruit {
	public static void main(String[] args) throws ParseException{			
		Connection conn = null;
		try{
			File inputfile = new File("C:\\Users\\BigData\\project\\Taichung_passionFruit(new).csv");  //可修改			
			String str;
			...
			String insStmt = "INSERT INTO passionFruit_production_price VALUES (?,?)";  //可修改
