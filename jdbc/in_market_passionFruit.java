...
public class in_market_passionFruit {
	public static void main(String[] args) throws ParseException{			
		Connection conn = null;
		try{
			File inputfile = new File("C:\\Users\\BigData\\project\\merge\\passionFruit.csv");  //可修改			
			String str;
			...
			String insStmt = "INSERT INTO market_passionFruit VALUES (?,?,?,?,?,?,?)";  //可修改
