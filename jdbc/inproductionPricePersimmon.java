...
public class inproductionPricePersimmon {
	public static void main(String[] args) throws ParseException{			
		Connection conn = null;
		try{
			File inputfile = new File("C:\\Users\\BigData\\project\\Taichung_persimmon(new).csv");  //可修改			
			String str;
			...
			String insStmt = "INSERT INTO persimmon_production_price VALUES (?,?)";  //可修改
